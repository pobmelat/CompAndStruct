...
60-electron effective core potential.\cite{andrae:epp:1990,weigend:def2:2005}
...
complexes, and free \ce{CO}. All structures retained in the adsorption
analysis were confirmed as minima by the absence of imaginary frequencies.
...
obtained after placing \ce{CO} at Pt sites.
...
\begin{figure}[H]
\centering
\input{neutral_data_sets_scheme}
...
The bonding patterns were analyzed with AdNDP~2.0\cite{tkachenko:adndp2:2019}.
The AdNDP searches included the chemically active valence space, with 10
...
channels were paired when possible. The spin-resolved elements and their
occupations are reported in Supporting

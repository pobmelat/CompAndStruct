...
\title{Interplay of Composition, Bonding, and Structural Reorganization in Pt10 and Pt--Ge clusters}
\title{Disentangling binding energies in the interaction between Pt10 and Pt-Ge clusters: composition, structural reorganization and spin state effects". O "Is there something better than binding energie? Seach toward local descriptors for CO adsorption in Pt10 and Pt-Ge clusters"
Reply}


\author[1,2,3]{Andoni Ugartemendia}
\author[1,2]{Idoia Camara}
\author[1,2]{Ramón M. Bergua}
...
\affil[3]{\small Istituto Nanoscienze, CNR, S3, via Campi 213/A, 41125 Modena, Italy}
...
\input{neutral_cluster_models}
\input{neutral_cluster_adsorption}
...
(Grant No. IT2067--26). A.U. gratefully thanks Gobierno Vasco-Eusko Jaurlaritza for his former predoctoral grant. We acknowledge DIPC and SGI-IZO-SGIker (UPV/EHU) for

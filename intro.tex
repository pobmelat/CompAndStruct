...
availability at Pt \textcolor{cyan}{sites}.
...
adsorption site affects both the \ce{CO} binding energy and stretching
...
supported Pt--Ge clusters.\cite{poths:2023b,li_size:2025} Taken together, these studies show
...
\textcolor{cyan}{Taken together, these studies show that Ge is not a passive diluent. It changes the local chemistry of Pt, the stability of the cluster, and the possible reaction pathways available under catalytic conditions. Nonetheless, despite a clear trend is found on the reduction of the affinity towards CO, they do not fully disentangle the joint contribution to the CO binding energies of local environment effects and the cluster structural response. In particular, it remains unclear whether the weaker binding strength associated with increasing Ge content reflects primarily a less favorable Pt--CO interaction or is associated in part with the energy expenditure/gain required to rearrange geometry upon CO adsorption. (Habria que mejorar esto. Mas añadir un parrafo anterior explicando las limitaciones del BE y necesidad de usar descriptores locales).}
\textcolor{red} {Previous studies have established that homoatomic Pt clusters exhibit a high affinity for CO, whereas Ge incorporation significantly weakens CO binding, particularly in clusters containing approximately equal numbers of Pt and Ge atoms. These findings demonstrate that Ge is not merely a passive diluent but actively modifies the local chemical environment of Pt, cluster stability, and the reaction pathways accessible under catalytic conditions. The reduced CO affinity has been attributed primarily to electronic effects arising from the strong covalent Pt–Ge bonding, in contrast to the delocalized metallic bonding characteristic of pure Pt clusters. However, this change in chemical bonding is also accompanied by substantial modifications in cluster geometry and electronic structure, including spin state, making it difficult to disentangle their individual contributions to CO adsorption. In particular, it remains unclear whether the lower CO binding energies observed upon Ge incorporation reflect an intrinsically weaker Pt–CO interaction or arise, at least in part, from differences in the energetic cost of cluster reorganization upon adsorption. The present study aims to disentangle the interplay between chemical bonding, geometry, and spin state in determining CO adsorption energetics, thereby providing a deeper understanding of the factors governing the reactivity of pure and Ge-doped Pt subnanoclusters.}

\textcolor{cyan}{Here, we address this question using...}The present work examines ten-atom \ce{Pt10} and \ce{Pt_{x}Ge_{10-x}} (where $x=4,5,6$)
\textcolor{cyan}{neutral} clusters using \textcolor{cyan}{density functional theory} (DFT\@) \textcolor{cyan}{to rationalize trends in CO binding strength of pure-Pt, Pt/Ge-rich and equimolar regimes in terms of structural rearrangement, electronic and spin state effects}. The study uses two crossed construction routes. In the first one, we start from the previously reported global-minimum (GM), \ce{Pt10} structure and replace selected Pt atoms by Ge. In the reverse route, we start from the previously reported GM
\ce{Pt5Ge5} structure and replace all Ge atoms by Pt, producing a pure-\ce{Pt10} derivative.\cite{ugartemendia:2022}   The most stable adsorption site for CO on this derivatives is subsequently characterized and examined.  This
procedure shows how the binding energy depends on composition, parent geometry,
spin state, local bonding, and relaxation of the whole cluster. 
